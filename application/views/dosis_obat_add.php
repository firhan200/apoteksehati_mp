...
<form action="<?php echo site_url('/dosis_obat/add_process/'.$obat['id']); ?>" method="post">
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                <label class="form-label">Dosis Obat</label>
                <input type="text" name="dosis" class="form-control" maxlength="150" placeholder="Masukan Dosis Obat.." required/>
            </div>
        </div>
    </div>
    <div class="row">
