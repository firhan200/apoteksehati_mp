...
<form action="<?php echo site_url('/obat/add_process/'.$kategori_obat['id']); ?>" method="post">
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                <label class="form-label">Nama Obat</label>
                <input type="text" name="nama_obat" class="form-control" maxlength="150" placeholder="Masukan Nama Obat.." required/>
            </div>
        </div>
    </div>
    <div class="row">
